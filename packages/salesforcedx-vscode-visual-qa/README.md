...
See `.claude/skills/telecode/SKILL.md` for Claude Code, OpenCode, and Cursor setup plus scripted and agent-driven workflows. Run the validated scripted example with:
