 ...
 */
export type CreateParams<T extends TemplateType = TemplateType> = {
  cwd: string;
  templateType: T;
  outputdir?: URI;
...
export type IServicesContract = {
  ...
  // Terminal
  readonly simpleExec: (command: string, parse?: (stdout: string) => string) => string;
 ...
 */
export type IServicesSyncMethods = {
