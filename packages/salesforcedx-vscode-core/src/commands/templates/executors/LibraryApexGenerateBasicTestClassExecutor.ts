...
export const CREATE_UNIT_NAME_KEY = 'apex_generate_basic_test_class_text';
export const TELEMETRY_NAME = 'force_apex_basic_class_create';

export class LibraryApexGenerateBasicTestClassExecutor extends LibraryBaseTemplateCommand<DirFileNameSelection> {
