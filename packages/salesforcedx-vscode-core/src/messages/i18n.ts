...
export const messages = {
  ...
  ActvPfrmDataConnectorS3: 'Activation Platform Data Connector S3',
  ...
  DataConnectorS3: 'Data Connector S3',
  ...
  GenAiFunction: 'Gen AI Functions',
  GenAiPlanner: 'Gen AI Planners',
  GenAiPlugin: 'Gen AI Plugins',
  GenAiPromptTemplate: 'Gen AI Prompt Templates',
  GenAiPromptTemplateActv: 'Gen AI Prompt Template Activities',
  ...
  MIDomain: 'MI Domains',
  MIModelConnection: 'MI Model Connections',
  MIModelSchema: 'MI Model Schemas',
  MktCalcInsightObjectDef: 'Mkt Calc Insight Object Definitions',
  MktDataConnection: 'Mkt Data Connections',
  MktDataConnectionSrcParam: 'Mkt Data Connection Src Params',
  MktDataTranObject: 'Mkt Data Tran Objects',
  MktDatalakeSrcKeyQualifier: 'Mkt Datalake Src Key Qualifiers',
