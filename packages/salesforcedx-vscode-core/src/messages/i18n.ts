...
export const messages = {
  ...
  rename_component_input_dup_file_name_error: 'This component name is already in use in the current component directory. Choose a different name and try again.',
