...
export const messages = {
  ...
  deploy_oas_failed: 'SFDX: Deploy This Open API Spec to Org command failed to run',
  retrieve_oas_failed: 'SFDX: Retrieve This Open API Spec from Org command failed to run',
