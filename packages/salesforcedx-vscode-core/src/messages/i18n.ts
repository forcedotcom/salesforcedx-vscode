...
export const messages = {
  ...
  force_apex_test_run_codeAction_all_tests_text:
    'SFDX: Invoke All Apex Tests in Class',
  force_apex_test_run_codeAction_all_tests_description_text: 'Run all %s tests',

  force_apex_test_run_codeAction_testMethod_text:
    'SFDX: Invoke Apex Test Method',
