...
import { apexGenerateBasicTestClass } from '../../../../src/commands/templates';
import { LibraryApexGenerateBasicTestClassExecutor } from '../../../../src/commands/templates/executors/LibraryApexGenerateBasicTestClassExecutor';
import {
...
jest.mock(
  '../../../../src/commands/templates/executors/LibraryApexGenerateBasicTestClassExecutor'
);
...
const libraryApexGenerateBasicTestClassExecutorMocked = jest.mocked(
...
describe('apexGenerateBasicTestClass Unit Tests.', () => {
  ...
  it('Should be able to execute apexGenerateBasicTestClass.', async () => {
    await apexGenerateBasicTestClass();
    ...
    expect(libraryApexGenerateBasicTestClassExecutorMocked).toHaveBeenCalled();
  ...
  it('Should prompt if the provided params are not valid.', async () => {
    ...
    await (apexGenerateBasicTestClass as any)(notAString, notAString2);
  ...
  it('Should used the passed parameters if provided.', async () => {
    ...
    await apexGenerateBasicTestClass(fileName, outputDir);
