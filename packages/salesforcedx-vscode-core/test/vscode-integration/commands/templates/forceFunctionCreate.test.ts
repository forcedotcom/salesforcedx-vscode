...
describe('Force Function Create', () => {
  ...
  describe('Pull Dependencies', () => {
    ...
    it('Should pull dependencies for javascript', async () => {
      ...
      sinon.assert.calledWith(execStub, 'npm install', { cwd: 'some/dir/functions/myFunc1' });
    });
    ...
    it('Should pull dependencies for java', async () => {
      ...
      sinon.assert.calledOnce(execStub);
      sinon.assert.calledWith(execStub, 'mvn install', { cwd: 'some/dir/functions/myFunc1/' });
    });
