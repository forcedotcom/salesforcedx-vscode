...
export const nameFromFile = (file: string, sfdxProject: boolean, converter: (a: string, b: string) => string): string | null => {
...
export const componentFromFile = (file: string, sfdxProject: boolean): string | null => nameFromFile(file, sfdxProject, componentName);
