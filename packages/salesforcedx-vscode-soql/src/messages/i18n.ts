...
export const messages = {
  ...
  soql_open_new_unsaved_warning: 'Do you want to save the changes you made to untitled.soql?',
  soql_open_new_unsaved_detail: 'Your changes will be lost if you create a new query without saving.',
  soql_open_new_unsaved_save: 'Save',
  soql_open_new_unsaved_dont_save: "Don't Save",
