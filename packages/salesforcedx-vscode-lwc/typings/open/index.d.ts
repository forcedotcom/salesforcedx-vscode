...
// IMPORTANT NOTE:
// The typings file included in the `open` package includes syntax that only
// works with typescript 3.4+: https://github.com/sindresorhus/open/issues/130
// Once the typescript version is updated, this file can be deleted and the
// "baseUrl" and "paths" properties in tsconfig.json can be removed.
