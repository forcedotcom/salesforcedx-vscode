...
export const messages = {
  ...
  jest_runner_duplicate_codelens_message:
    'Both the SFDX LWC extension and the Jest Runner extension show test code lenses. The "(LWC)" lenses run tests in the Test Explorer with native results.',
  jest_runner_dont_show_again_button: "Don't show again",
