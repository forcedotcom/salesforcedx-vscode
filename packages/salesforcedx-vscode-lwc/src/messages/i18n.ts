...
export const messages = {
  ...
  force_lightning_lwc_inactive_scratch_org:
    'The local development server couldn’t start as your scratch org is not active. Run "SFDX: Create a Default Scratch Org" to create a scratch org, or run "SFDX: Set a Default Org" to switch to an active scratch org.',
