...
export const messages = {
  ...
  force_lightning_lwc_deprecated_redhat_extension: 'Salesforce js-meta.xml intellisense requires RedHat XML Extension Version >= 0.14.0. Please upgrade the RedHat XML Extension.',
