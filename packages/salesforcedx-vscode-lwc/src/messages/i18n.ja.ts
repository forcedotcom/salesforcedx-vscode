...
export const messages = {
  ...
  force_lightning_lwc_start_text: 'SFDX: ローカルの開発サーバを起動',
  ...
  force_lightning_lwc_platform_selection:
    'コンポーネントをプレビューするプラットフォームを選択',
  force_lightning_lwc_android_target_default:
    'Android エミュレータの名前を入力 (デフォルトの場合は空)',
  force_lightning_lwc_ios_target_default:
    'iOS シミュレータの名前を入力 (デフォルトの場合は空)',
  force_lightning_lwc_android_target_remembered:
    "Android エミュレータの名前を入力 ('%s' の場合は空)",
  force_lightning_lwc_ios_target_remembered:
    "iOS シミュレータの名前を入力 ('%s' の場合は空)",
  force_lightning_lwc_operation_cancelled:
    'プレビュー操作がユーザによりキャンセルされました。',
  force_lightning_lwc_ios_label: 'iOS シミュレータを使用',
  force_lightning_lwc_ios_description: 'iOS 上でコンポーネントをプレビュー',
  force_lightning_lwc_android_label: 'Android エミュレータを使用',
  force_lightning_lwc_android_description:
    'Android 上でコンポーネントをプレビュー',
  force_lightning_lwc_android_failure:
    "Android エミュレータ '%s' の起動に失敗しました。",
  force_lightning_lwc_ios_failure:
    "iOS シミュレータ '%s' の起動に失敗しました。",
  force_lightning_lwc_android_start:
    "Android エミュレータ '%s' を起動しています。",
