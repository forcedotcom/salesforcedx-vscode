...
describe('breakpointService Unit Tests.', () => {
  ...
  describe('isApexDebuggerBreakpointId()', () => {
    ...
    it('Should return false if isApexDebuggerBreakpointId is empty.', () => {
      expect(
        breakpointService.isApexDebuggerBreakpointId('NOT_THE_DEBUGGER_ID')
      ).toBeFalsy();
    });
  ...
  describe('createLineBreakpoint()', () => {
    it('Should resolve to breakpointId if found.', async () => {
      ...
      const result = await breakpointService.createLineBreakpoint(
        'fake/project/path',
        'fakeSessionId',
        'test',
        1
    ...
    it('Should reject with result if not a breakpoint id.', () => {
      ...
      expect(
        breakpointService.createLineBreakpoint(
          'fake/project/path',
          'fakeSessionId',
          'test',
          1
  ...
  describe('deleteBreakpoint()', () => {
    it('Should resolve to breakpointId if deleted.', async () => {
      ...
      const result = await breakpointService.deleteBreakpoint(
        'fake/project/path',
        bpId
      );
      expect(executeMock).toHaveBeenCalled();
  ...
  describe('createExceptionBreakpoint()', () => {
    ...
    it('Should reject with result if not a breakpoint id.', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-floating-promises
      expect(
        breakpointService.createExceptionBreakpoint(
          'fake/project/path',
          'fakeSessionId',
          'fakeTypeRef'
        )
