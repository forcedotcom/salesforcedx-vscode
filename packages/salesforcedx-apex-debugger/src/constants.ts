...
export const DEFAULT_IDLE_QUESTION_TIMEOUT_MS = 10000;
...
export const SEND_HEARTBEAT_REQUEST = 'sendHeartbeat';
export const TERMINATE_SESSION_REQUEST = 'terminateSession';
export const IDLE_SESSION_REQUEST = 'idleSession';
export const RESET_HEARTBEAT_EVENT = 'resetHeartbeat';
