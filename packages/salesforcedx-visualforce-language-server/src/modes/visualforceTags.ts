...
import type { IAttributeData, IHTMLDataProvider, ITagData, IValueData } from 'vscode-html-languageservice';

const visualforceTag = (label: string, documentation: string, attributes: string[] = []) => ({
  label,
  documentation,
  attributes
});
...
type VisualforceTagSet = {
  [tag: string]: ReturnType<typeof visualforceTag>;
};

const getTag = (tag: string) => VISUALFORCE_TAGS[tag.toLowerCase()];
const getAttribute = (tag: string, attribute: string) =>
  getTag(tag)?.attributes.find(candidate => candidate.split(':')[0].toLowerCase() === attribute.toLowerCase());

export const visualforceDataProvider: IHTMLDataProvider = {
  getId: () => 'visualforce',
  isApplicable: languageId => languageId === 'visualforce',
  provideTags: (): ITagData[] =>
    Object.values(VISUALFORCE_TAGS).map(({ label, documentation }) => ({
      name: label,
      description: documentation,
      attributes: []
    })),
  provideAttributes: (tag: string): IAttributeData[] =>
    (getTag(tag)?.attributes ?? []).map(attribute => ({
      name: attribute.split(':')[0]
    })),
  provideValues: (tag: string, attribute: string): IValueData[] =>
    getAttribute(tag, attribute)?.endsWith(':b') ? [{ name: 'true' }, { name: 'false' }] : []
};

const VISUALFORCE_TAGS: VisualforceTagSet = {
  'analytics:reportchart': visualforceTag(
  ...
  'apex:actionfunction': visualforceTag(
    'apex:actionFunction',
  ...
  'apex:actionpoller': visualforceTag(
    'apex:actionPoller',
  ...
  'apex:actionregion': visualforceTag(
    'apex:actionRegion',
  ...
  'apex:actionstatus': visualforceTag(
    'apex:actionStatus',
  ...
  'apex:actionsupport': visualforceTag(
    'apex:actionSupport',
  ...
  'apex:areaseries': visualforceTag(
    'apex:areaSeries',
  ...
  'apex:chartlabel': visualforceTag(
    'apex:chartLabel',
  ...
  'apex:commandbutton': visualforceTag(
    'apex:commandButton',
  ...
  'apex:commandlink': visualforceTag(
    'apex:commandLink',
  ...
  'apex:componentbody': visualforceTag(
    'apex:componentBody',
  ...
  'apex:componentexample': visualforceTag(
  ...
  'apex:composition': visualforceTag(
    'apex:composition',
  ...
  'apex:description': visualforceTag('apex:description', '', []),
  'apex:detail': visualforceTag(
    'apex:detail',
  ...
  'apex:dynamiccomponent': visualforceTag(
  ...
  'apex:enhancedlist': visualforceTag(
    'apex:enhancedList',
  ...
  'apex:flash': visualforceTag('apex:flash', 'A Flash movie, rendered with the HTML object and embed tags.', [
    'flashvars',
    'height',
    'id',
    'loop:b',
  ...
  'apex:gaugeseries': visualforceTag(
    'apex:gaugeSeries',
  ...
  'apex:includelightning': visualforceTag(
  ...
  'apex:includescript': visualforceTag(
    'apex:includeScript',
  ...
  'apex:inlineeditsupport': visualforceTag(
  ...
  'apex:inputcheckbox': visualforceTag(
    'apex:inputCheckbox',
  ...
  'apex:inputfield': visualforceTag(
    'apex:inputField',
  ...
  'apex:inputhidden': visualforceTag(
    'apex:inputHidden',
  ...
  'apex:inputsecret': visualforceTag(
    'apex:inputSecret',
  ...
  'apex:inputtextarea': visualforceTag(
    'apex:inputTextarea',
  ...
  'apex:lineseries': visualforceTag(
    'apex:lineSeries',
  ...
  'apex:logcallpublisher': visualforceTag(
  ...
  'apex:outputfield': visualforceTag(
    'apex:outputField',
  ...
  'apex:outputlabel': visualforceTag(
    'apex:outputLabel',
  ...
  'apex:outputlink': visualforceTag(
    'apex:outputLink',
  ...
  'apex:outputpanel': visualforceTag(
    'apex:outputPanel',
  ...
  'apex:outputtext': visualforceTag(
    'apex:outputText',
  ...
  'apex:pageblockbuttons': visualforceTag(
  ...
  'apex:pageblocksection': visualforceTag(
  ...
  'apex:pageblocksectionitem': visualforceTag(
  ...
  'apex:pageblocktable': visualforceTag(
    'apex:pageBlockTable',
  ...
  'apex:pagemessage': visualforceTag(
    'apex:pageMessage',
  ...
  'apex:pagemessages': visualforceTag(
    'apex:pageMessages',
  ...
  'apex:panelbaritem': visualforceTag(
    'apex:panelBarItem',
  ...
  'apex:panelgroup': visualforceTag(
    'apex:panelGroup',
  ...
  'apex:radarseries': visualforceTag(
    'apex:radarSeries',
  ...
  'apex:relatedlist': visualforceTag(
    'apex:relatedList',
  ...
  'apex:remoteobjectfield': visualforceTag(
  ...
  'apex:remoteobjectmodel': visualforceTag(
  ...
  'apex:remoteobjects': visualforceTag(
    'apex:remoteObjects',
  ...
  'apex:scatterseries': visualforceTag(
    'apex:scatterSeries',
  ...
  'apex:sectionheader': visualforceTag(
    'apex:sectionHeader',
  ...
  'apex:selectcheckboxes': visualforceTag(
  ...
  'apex:selectlist': visualforceTag(
    'apex:selectList',
  ...
  'apex:selectoption': visualforceTag(
    'apex:selectOption',
  ...
  'apex:selectoptions': visualforceTag(
    'apex:selectOptions',
  ...
  'apex:selectradio': visualforceTag(
    'apex:selectRadio',
  ...
  'apex:stylesheet': visualforceTag(
    'apex:stylesheet',
  ...
  'apex:toolbargroup': visualforceTag(
    'apex:toolbarGroup',
  ...
  'apex:vote': visualforceTag(
    'apex:vote',
    'A component that displays the vote control for an object that supports it.',
    ['id', 'objectId', 'rendered:b', 'rerender']
  ),
  'c:myvfcomponent': visualforceTag('c:myvfcomponent', '', ['id', 'rendered:b']),
  'chatter:feed': visualforceTag(
    'chatter:feed',
  ...
  'chatter:feedwithfollowers': visualforceTag(
  ...
  'chatter:followers': visualforceTag(
    'chatter:followers',
  ...
  'chatter:newsfeed': visualforceTag(
    'chatter:newsfeed',
  ...
  'chatter:userphotoupload': visualforceTag(
  ...
  'flow:interview': visualforceTag('flow:interview', 'This component embeds a Flow interview in the page.', [
    'allowShowPause:b',
    'buttonLocation',
    'buttonStyle',
    'finishLocation',
  ...
  'ideas:detailoutputlink': visualforceTag(
  ...
  'ideas:listoutputlink': visualforceTag(
  ...
  'ideas:profilelistoutputlink': visualforceTag(
  ...
  'knowledge:articlecasetoolbar': visualforceTag(
  ...
  'knowledge:articlelist': visualforceTag(
  ...
  'knowledge:articlerenderertoolbar': visualforceTag(
  ...
  'knowledge:articletypelist': visualforceTag('knowledge:articleTypeList', 'A loop on all available article types.', [
    'articleTypeVar',
    'id',
    'rendered:b'
  ]),
  'knowledge:categorylist': visualforceTag(
  ...
  'liveagent:clientchat': visualforceTag(
  ...
  'liveagent:clientchatalertmessage': visualforceTag(
  ...
  'liveagent:clientchatcancelbutton': visualforceTag(
  ...
  'liveagent:clientchatendbutton': visualforceTag(
    'liveAgent:clientChatEndButton',
    ' The button within a Live Agent chat window a visitor clicks to end a chat session.\n\n Must be used within < liveAgent:clientChat >.\n\n',
    ['id', 'label', 'rendered:b']
  ),
  'liveagent:clientchatfiletransfer': visualforceTag(
  ...
  'liveagent:clientchatinput': visualforceTag(
  ...
  'liveagent:clientchatlog': visualforceTag(
  ...
  'liveagent:clientchatlogalertmessage': visualforceTag(
  ...
  'liveagent:clientchatmessages': visualforceTag(
  ...
  'liveagent:clientchatqueueposition': visualforceTag(
  ...
  'liveagent:clientchatsavebutton': visualforceTag(
  ...
  'liveagent:clientchatsendbutton': visualforceTag(
  ...
  'liveagent:clientchatstatusmessage': visualforceTag(
  ...
  'messaging:attachment': visualforceTag('messaging:attachment', 'Compose an attachment and append it to the email.', [
    'filename',
    'id',
    'inline:b',
    'renderAs',
  ...
  'messaging:htmlemailbody': visualforceTag('messaging:htmlEmailBody', 'The HTML version of the email body.', [
    'id',
    'rendered:b'
  ]),
  'messaging:plaintextemailbody': visualforceTag(
    'messaging:plainTextEmailBody',
    'The plain text (non-HTML) version of the email body.',
    ['id', 'rendered:b']
  ),
  'site:googleanalyticstracking': visualforceTag(
  ...
  'site:previewasadmin': visualforceTag(
    'site:previewAsAdmin',
  ...
  'social:profileviewer': visualforceTag(
  ...
  'support:casearticles': visualforceTag(
  ...
  'support:casefeed': visualforceTag(
    'support:caseFeed',
  ...
  'support:caseunifiedfiles': visualforceTag('support:caseUnifiedFiles', 'Displays the Files component.', [
    'entityId',
    'id',
    'rendered:b'
  ]),
  'support:clicktodial': visualforceTag(
    'support:clickToDial',
