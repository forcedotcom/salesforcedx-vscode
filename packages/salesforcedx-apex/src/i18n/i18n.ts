...
export const messages = {
  ...
  invalidTestRunIdErr:
    'The test run id %s isn\'t in the correct format for "id." The ID is a 15- or 18-character string in the format "707xxxxxxxxxxxx"',
  invalidsObjectErr:
    "You don't have permissions to access sObject of type %s. Ask your Salesforce admin to give you permissions to access Apex code and the Streaming API. \nError: %s",
  ...
  runTestReportCommand: 'Run "sf apex get test -i %s -o %s" to retrieve test results.'
};
