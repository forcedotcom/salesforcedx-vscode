 ...
 * health-check) is owned by the orchestrator/CI, not this fixture. The fixture only lands the page
 * on a ready workbench, so specs reuse the existing plain-`Page` page objects unchanged.
 *
