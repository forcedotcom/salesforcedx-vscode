...
- [Salesforce Metadata Visualizer](https://marketplace.visualstudio.com/items?itemName=salesforce.salesforce-metadata-visualizer) This extension (`salesforce-metadata-visualizer`) provides visual representations of Salesforce metadata including entity relationship diagrams for objects, flow diagrams, FlexiPage layouts, and permission set visualizations.
