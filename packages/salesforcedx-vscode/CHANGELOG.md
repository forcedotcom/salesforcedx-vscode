...
- W-21523688  Expose TypeScript support in VS Code extensions ([PR #7033](https://github.com/forcedotcom/salesforcedx-vscode/pull/7033))
...
- Updating ui bundles to the latest ([PR #7116](https://github.com/forcedotcom/salesforcedx-vscode/pull/7116))
