...
- We fixed an issue where an empty abstract method wasn't correctly parsed and displayed in the Outline view. ([PR #5555](https://github.com/forcedotcom/salesforcedx-vscode/pull/5555))
