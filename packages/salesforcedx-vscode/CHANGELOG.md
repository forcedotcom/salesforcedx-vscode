...
* Handling of inner interface and implicit constructors for Go To Definition & Find All References ([PR #353](https://github.com/forcedotcom/salesforcedx-vscode/pull/353))
