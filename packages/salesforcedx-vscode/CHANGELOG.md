...
- We fixed an issue where the `SFDX: Create Lightning Web Component Test` command threw an error when you exited out of the command. ([PR #4143](https://github.com/forcedotcom/salesforcedx-vscode/pull/4143))
