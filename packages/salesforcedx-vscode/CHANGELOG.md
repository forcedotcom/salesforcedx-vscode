...
- We made some changes that prevents the output panel from opening when the `SFDX: Refresh SObject Definitions` command is run in a container environment. ([PR #5042](https://github.com/forcedotcom/salesforcedx-vscode/pull/5042))
