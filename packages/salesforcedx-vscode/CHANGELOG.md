...
- We fixed an issue where you could run the `SFDX Generate Manifest FIle` command to create a manifest file from any folder in your project. The command is now only available on right click on the `force-app`, package directory folder.  ([PR #4208](https://github.com/forcedotcom/salesforcedx-vscode/pull/4208))
