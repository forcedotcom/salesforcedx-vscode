...
* Make extension resilient against STDERR messages (warnings, available updates) when parsing `--json` output. ([PR #406](https://github.com/forcedotcom/salesforcedx-vscode/pull/406))
