...
exports.dashboard = exports.appToTemplateRules = exports.folder = exports.releaseNotes = exports.templateInfo = exports.templateToAppRules = exports.ui = exports.variables = void 0;
/*
...
exports.ui = ['{', '  "pages": [],', '  "displayMessages": []', '}'].join('\n');
exports.templateToAppRules = [
    '{',
    '  "constants": [],',
    '  "macros": [],',
    '  "rules": []',
...
exports.releaseNotes = '<h2>Release Notes for Template</h2>';
exports.folder = [
    '{',
    '  "name": "sat1",',
    '  "label": "sat1",',
...
//# sourceMappingURL=sampleAnalyticsTemplateData.js.map