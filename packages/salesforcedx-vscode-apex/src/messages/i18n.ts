...
export const messages = {
  ...
  source_missing_text:
    '%s points to a missing folder. For more information on how to setup the Salesforce Apex extension, go to [Set Your Java Version](%s).',
  ...
  wrong_java_version_text:
    'Java 8 is required to run. Download and install it from https://java.com/en/download/. For more information, go to [Set Your Java Version](%s).',
