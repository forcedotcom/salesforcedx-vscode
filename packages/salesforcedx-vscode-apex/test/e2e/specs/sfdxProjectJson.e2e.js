...
describe('Customize sfdx-project.json', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        (0, mocha_steps_1.step)('Set up the testing environment', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        testSetup = _a.sent();
                        return [4 /*yield*/, createSfdxProjectJsonWithAllFields(testSetup)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, utilities.reloadAndEnableExtensions()];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        (0, mocha_steps_1.step)('Verify our extensions are loaded after updating sfdx-project.json', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
...
function createSfdxProjectJsonWithAllFields(testSetup) {
    return __awaiter(this, void 0, void 0, function () {
        var workbench, sfdxConfig, textEditor;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, utilities.openFile(path_1.default.join(testSetup.projectFolderPath, 'sfdx-project.json'))];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, utilities.getTextEditor(workbench, 'sfdx-project.json')];
                case 2:
                    textEditor = _a.sent();
                    return [4 /*yield*/, textEditor.setText(sfdxConfig)];
                case 3:
                    _a.sent();
