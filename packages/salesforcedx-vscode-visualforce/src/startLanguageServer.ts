    ...
    const colorDisposable = languages.registerColorProvider(
      ...
      ],
      {
        provideDocumentColors: (document: TextDocument): Thenable<ColorInformation[]> => {
          ...
          return client.sendRequest<LSPColorInformation[]>('textDocument/documentColor', params).then(symbols =>
        ...
        provideColorPresentations: (
          ...
          return client
            .sendRequest<LSPColorPresentation[]>('textDocument/colorPresentation', params)
