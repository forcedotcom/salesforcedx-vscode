...
function createVisualforcePage() {
    return __awaiter(this, void 0, void 0, function () {
        var inputBox, workbench, textEditor, pageText;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    (0, miscellaneous_1.log)("calling createVisualforcePage()");
                    return [4 /*yield*/, (0, commandPrompt_1.executeQuickPick)('SFDX: Create Visualforce Page')];
                case 1:
                    inputBox = _a.sent();
                    // Set the name of the new Visualforce Page
                    return [4 /*yield*/, inputBox.setText('FooPage')];
                case 2:
                    // Set the name of the new Visualforce Page
                    _a.sent();
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, textEditorView_1.getTextEditor)(workbench, 'FooPage.page')];
                case 6:
                    textEditor = _a.sent();
                    pageText = [
                    ...
                    return [4 /*yield*/, textEditor.setText(pageText)];
                case 7:
                    _a.sent();
