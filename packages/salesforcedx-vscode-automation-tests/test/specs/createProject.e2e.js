...
describe('SFDX: Create Project', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        (0, mocha_steps_1.step)('Set up testing environment', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        (0, mocha_steps_1.step)('Execute command SFDX: Create Project', function () { return __awaiter(void 0, void 0, void 0, function () {
            var prompt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        utilities.log("Starting command SFDX: Create Project...");
                        return [4 /*yield*/, utilities.executeQuickPick('SFDX: Create Project')];
                    case 1:
                        prompt = _a.sent();
                        return [4 /*yield*/, utilities.waitForQuickPick(prompt, 'Standard', {
                    ...
                    case 3:
                        // Enter the project's name.
                        _a.sent();
                        return [4 /*yield*/, prompt.setText(testSetup.tempProjectName)];
                    case 4:
                        _a.sent();
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, prompt.setText(testSetup.tempFolderPath)];
                    case 7:
                        // Set the location of the project.
                        _a.sent();
                        return [4 /*yield*/, utilities.pause(utilities.Duration.seconds(2))];
        ...
        (0, mocha_steps_1.step)('Verify the project is created and open in the workspace', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // Verify the project was created and was loaded.
                    return [4 /*yield*/, utilities.verifyProjectLoaded(testSetup.tempProjectName)];
                    case 1:
                        // Verify the project was created and was loaded.
                        _a.sent();
                        return [2 /*return*/];
