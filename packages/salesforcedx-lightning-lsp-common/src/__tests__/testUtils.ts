...
export const CORE_WORKSPACE_STRUCTURE = {
    ...
    'ui-global-components/modules/one/app-nav-bar/app-nav-bar.js': 'export default class AppNavBar extends LightningElement {}',
    ...
    'ui-force-components/modules/force/input-phone/input-phone.js': 'export default class InputPhone extends LightningElement {}',
    ...
    'ui-other-components/modules/other/example-component/example-component.html': '<template><div>Example Component</div></template>',
    'ui-other-components/modules/other/example-component/example-component.js': 'export default class ExampleComponent extends LightningElement {}',
...
export const populateFileSystemProvider = (fileSystemProvider: FileSystemDataProvider, workspacePath: string, structure: Record<string, string>): void => {
    ...
    if (structure === CORE_PARTIAL_WORKSPACE_STRUCTURE) {
        ...
        fileSystemProvider.updateFileContent(parentWorkspaceUserFile, '<?xml version="1.0" encoding="UTF-8"?><workspace></workspace>');
    }
    ...
    directories.forEach((dirPath) => {
        ...
        const childPaths = allPaths.filter((p) => p.startsWith(`${dirPath}/`) && !p.substring(dirPath.length + 1).includes('/'));
...
coreMultiFileSystemProvider.updateFileContent(coreMultiParentWorkspaceUserFile, '<?xml version="1.0" encoding="UTF-8"?><workspace></workspace>');
