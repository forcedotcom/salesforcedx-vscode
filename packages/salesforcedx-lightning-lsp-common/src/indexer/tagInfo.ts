...
const getComponentLibraryLink = (tagInfo: TagInfo): string | null =>
...
const getAttributeMarkdown = (attribute: AttributeInfo): string => {
...
const getMethodMarkdown = (method: ClassMember): string => {
