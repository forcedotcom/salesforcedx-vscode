...
export const IONIC_TAGS: ITagSet = {
  ...
  'ion-delete-button': new HTMLTagSpecification(
    localize('tags.ion.deletebutton', 'Child of ionItem'),
    []
  ),
  ...
  'ion-item': new HTMLTagSpecification(
    localize('tags.ion.item', 'Child of ionList.'),
    []
  ),
  ...
  'ion-reorder-button': new HTMLTagSpecification(
    localize('tags.ion.reorderbutton', 'Child of ionItem.'),
    ['on-reorder']
  ),
...
export function getIonicTagProvider(): IHTMLTagProvider {
  ...
  return {
    ...
    isApplicable: languageId => languageId === 'html',
    collectTags: (collector: (tag: string, label: string) => void) =>
      collectTagsDefault(collector, IONIC_TAGS),
    collectAttributes: (
      tag: string,
      collector: (attribute: string, type: string) => void
    ) => {
