...
export const messages = {
  ...
  command_succeeded_text: '%s successfully ran',
  ...
  org_create_authorize_dev_hub_failed: 'Could not start SFDX: Authorize a Dev Hub. %s',
  ...
  org_delete_success: 'Successfully deleted org %s.',
