...
export const createOrgPicker = Effect.fn('OrgPicker.createOrgPicker')(function* () {
  ...
  const orgPickerStatuBarItem = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 49);
  const orgOpenStatusBarItem = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 50);
