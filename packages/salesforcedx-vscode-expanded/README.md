...
- **[Visual Studio Code](https://code.visualstudio.com/download) (latest - 2)** - You must be within 2 months of the latest VSCode version
...
- [Salesforce Metadata Visualizer](https://marketplace.visualstudio.com/items?itemName=salesforce.salesforcedx-metadata-visualizer-vscode)
  This extension (`salesforcedx-metadata-visualizer-vscode`) creates visual diagrams of metadata in real-time, making it easier to understand its structure and relationships compared to reviewing raw metadata files. You can visualize metadata generated by AI using Agentforce Vibes or from your SFDX project, enabling you to easily understand and analyze code.
