...
export const messages = {
  ...
  project_generate_internal_app_template_display_text: 'Internal App',
  project_generate_internal_app_template: 'For employees signing in with Salesforce credentials (B2E).',
  project_generate_external_app_template_display_text: 'External App',
  project_generate_external_app_template: 'For customers or partners signing in outside your org (B2C).',
  project_generate_react_framework_display_text: 'React',
  project_generate_angular_framework_display_text: 'Angular',
  project_generate_react_b2e_template: 'React-based internal app. Sample app: Property Management App.',
  project_generate_react_b2x_template: 'React-based external app. Sample app: Property Rental App.',
  project_generate_angular_b2e_template: 'Angular-based internal app template.',
  project_generate_angular_b2x_template: 'Angular-based external app template.',
  project_generate_type_placeholder: 'Select a project template',
  project_generate_framework_placeholder: 'Select a framework',
