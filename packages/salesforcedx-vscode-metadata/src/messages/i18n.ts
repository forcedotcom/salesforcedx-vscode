...
export const messages = {
  ...
  project_generate_react_internal_app_display_text: 'React Internal App',
  project_generate_angular_internal_app_display_text: 'Angular Internal App',
  project_generate_react_external_app_display_text: 'React External App',
  project_generate_angular_external_app_display_text: 'Angular External App',
  project_generate_react_b2e_template: 'For employees (Salesforce login). Sample: Property Management App',
  project_generate_react_b2x_template: 'For users signing in outside your org. Sample: Property Rental App',
  project_generate_angular_b2e_template: 'For employees (Salesforce login)',
  project_generate_angular_b2x_template: 'For users signing in outside your org',
  project_generate_separator_internal_apps: 'Internal Apps (B2E)',
  project_generate_separator_external_apps: 'External Apps (B2C)',
