...
This is an internal module to the VSCode Extensions for Salesforce that is used for
sharing functionality across the VSCode Salesforce Extension code base when there
is not a dependency on the vscode module. This is necessary due to needing the ability
