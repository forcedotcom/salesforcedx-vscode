...
Microsoft is aware of this issue. For details, see [Debugger extension receives different order of requests with an active Live Share session #480](https://github.com/MicrosoftDocs/live-share/issues/480).
