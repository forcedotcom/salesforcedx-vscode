...
export const messages = {
  ...
  isv_debug_bootstrap_progress_title: 'SFDX: ISV Debugger Setup',
  ...
  debugger_stop_text: 'Stopping Apex Debugger session…',
  debugger_stop_none_found_text: 'No Apex Debugger session found.',
  debugger_stop_success_text: 'Apex Debugger session stopped.'
} as const;
