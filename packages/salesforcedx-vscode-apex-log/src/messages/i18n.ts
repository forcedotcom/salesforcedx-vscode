...
export const messages = {
  ...
  trace_flag_user_type_standard: 'Users (Standard)',
  trace_flag_user_type_automated_process: 'Automated Process',
  trace_flag_user_type_partner: 'Partner',
  trace_flag_user_type_customer_portal: 'Customer/Portal',
  trace_flag_user_type_guest: 'Guest',
