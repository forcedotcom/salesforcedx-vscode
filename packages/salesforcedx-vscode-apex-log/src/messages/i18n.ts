...
export const messages = {
  ...
  apex_class_unit_test_template_description: 'Unit test template with sample test method',
  apex_class_basic_unit_test_template_description: 'Minimal unit test template',
  apex_class_batchable_template_description: 'Batchable Apex class',
  apex_class_queueable_template_description: 'Queueable Apex class',
