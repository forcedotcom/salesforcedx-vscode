...
export const computeFrameName = (fields: string[]): string => {
...
export const isExtraneousVFGetterOrSetterLogLine = (logLine: string): boolean =>
  logLine.match(getMatch) == null && logLine.match(setMatch) == null ? false : true;
