...
- **Code Builder container** (`test:container`) — runs the core extension against the real Code Builder image, swapping the freshly-built extensions into the running `code-server` container.
