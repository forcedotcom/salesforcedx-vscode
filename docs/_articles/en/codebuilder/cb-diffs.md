...
- Code Builder is installed as a managed package, and it comes with everything you needcwith Salesforce Extensions and Salesforce CLI. No installation required.
