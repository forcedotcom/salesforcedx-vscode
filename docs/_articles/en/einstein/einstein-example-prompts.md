...
To extract accurate and relevant information from the model, first run **SFDX:Refresh SObjects Definitions** to gather org metadata in the form of object definitions into your project beyond running your query. Then ground your prompts further with org context awareness to generate a high-quality response.
