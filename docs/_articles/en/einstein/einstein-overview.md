...
- Generate boilerplate code from natural language instructions, in a side bar. Lets you work with the tool side by side without any interruptions to your workflow.
...
**Honesty:** We ensure that the data we use in our models respects data provenance and we that we have consent to use the data.
