...
Einstein for Developers is disabled by default in new Code Builder environments. Telemtry is used to audit enablement of Salesforce Generative AI functionality and must be on during enablement. To enable this extension in a new environment:
