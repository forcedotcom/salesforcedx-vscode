...
| [ISV Debugger](./en/apex/isv-debugger)          | - Available in subscriber sandbox orgs and scratch orgs.<br>- Can be used in scratch orgs using the DebugApex feature. The scratch orgs must be created on a Partner Business Org (PBO) that has an interactive debugger license. For ISVs, the PBO is their Dev Hub org.                                                                                                                                                                              | Use to debug managed package code directly in customer orgs in real time.              |
