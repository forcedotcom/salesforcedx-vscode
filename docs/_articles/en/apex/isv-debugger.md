...
1. Log into your License Management Org (LMO) and enable the **View and Debug Managed Apex** permission for your users in Setup using profiles or permission sets.
