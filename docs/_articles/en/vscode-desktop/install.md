...
Some features in Salesforce Extensions for VS Code depend upon the Java Platform, Standard Edition Development Kit (JDK). You need to have either version 8, 11 or 17 of the JDK installed. See [Java Setup](./java-setup) for details.
