...
Einstein for Developers runs in an Apex file in the VS Code Editor.
...
You successfully received your first code suggestion, but that is just the beginning! Use our example prompts to exercise your code generation muscle and learn how to get the most out of the generative AI tool.
