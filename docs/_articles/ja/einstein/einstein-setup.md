...
|                                                     |                                            |
| --------------------------------------------------- | ------------------------------------------ |
| Install and configure Einstein for Developers(beta) | `CustomizeApplication` and `ModifyAllData` |
...
Einstein for Developers(beta)is available in the VS Code marketplace.
...
Open a Salesforce DX project in VS Code, and confirm that the extension is installed.

![vsix command location](../../../images/einstein_installed.png)

**Note:** Install Salesforce Extensions and Salesforce CLI on your desktop to use Einstein for Developers(beta) locally.
